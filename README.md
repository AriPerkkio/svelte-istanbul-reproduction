...
Check `./generated/` for results:

```
/x/svelte-istanbul-reproduction
├── debug-svelte-sourcemaps.mjs
└── generated
   ├── coverage-final.json
   ├── coverage-pre.json
   ├── instrumented.js
   ├── instrumented.js.map
   ├── instrumented.mappings.json
   ├── instrumented.remapped.md
   ├── transpiled.js
   ├── transpiled.js.map
   ├── transpiled.mappings.json
   └── transpiled.remapped.md
```
